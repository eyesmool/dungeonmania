...
public class NameConverter {
    public static String toSnakeCase(Entity entity) {
        ...
        if (entity instanceof LightBulbOff) {
            boolean isActivated = ((LightBulbOff) entity).isActivated();
            if (isActivated) {
                nameBasic = "light_bulb_on";
                System.out.println("helloooo from name converter");
                return nameBasic;
            } else {
                nameBasic = "light_bulb_off";
                return nameBasic;
            }
        }
        return nameBasic;
